...
- 两位玩家，分别为蓝方和红方。
  ...
  - ![image-20231126125058139](https://github.com/Mr-xiaotian/Celestial-Chess/blob/main/img/image-20231126125058139.png)
  - ![image-20231126125625095](https://github.com/Mr-xiaotian/Celestial-Chess/blob/main/img/image-20231126125625095.png)
...
2. **分数影响**：
   ...
   - 落子点的右侧、上方和下方的格子，其与落子点间的方格距离为L，则其变化绝对值为max(X-L, 0)。
     ...
     - ![image-20231126125336304](https://github.com/Mr-xiaotian/Celestial-Chess/blob/main/img/image-20231126125336304.png)
3. **黑洞点**：
   - 如果任何格子的分数（绝对值）达到或超过2X+3，该格子变成黑洞点。
   - 黑洞产生点周围的点也会成为黑洞点，与落子不同，呈反向扩散趋势，影响距离为X-1。
     - 如下图，黑洞产生点为第四行第四列，除这一点外其右侧的点也扩散性变为黑洞点，
     - ![image-20231126125551912](https://github.com/Mr-xiaotian/Celestial-Chess/blob/main/img/image-20231126125551912.png)
   - 黑洞点阻止其周围的分数传播。
